        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "❰𝗤𝘂𝗲𝗲𝗻❱", url="https://t.me/candy_626"
                    )]
            ]
        ),
...
async def start(client: Client, message: Message):
    ...
    await message.reply_text(
        f"""✅ **ᴀʟɪꜱʜᴀ ꜱᴇʀᴠᴇʀ ɪꜱ ʀᴜɴɴɪɴɢ**\n<b>💠 **ᴜᴘᴛɪᴍᴇ:**</b> `{uptime}`""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "✨ ɢʀᴏᴜᴘ", url=f"https://t.me/AlishaSupport"
                    ),
                    InlineKeyboardButton(
                        "📣 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/pubglovers_shayri_lovers"
                    )
                ]
            ]
        )
